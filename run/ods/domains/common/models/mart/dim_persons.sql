    ...
    create  table
      "ods"."banner"."dim_persons__dbt_tmp"
  
    as (
      with 

banner_persons        as (select * from "ods"."banner"."int_banner__entities__filtered_to__persons"),

banner_person_details as (select * from "ods"."banner"."int_banner__person_details"),
